...
from inputoutput.hdf5datasetwriter import HDF5hdDatasetWriter
...
# grab the image paths and initialize the total number of crops processed
...
for imagePath in imagePaths:
	...
	# that it tiles nicely when we generate the training data + labels
	(h, w) = image.shape[:2]
